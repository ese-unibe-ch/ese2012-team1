...
class ItemActionsTest < Test::Unit::TestCase
  ...
  describe 'Simple Tests' do
    ...
    it 'post /item/changestate/setactive should set an item active' do
      ...
      post '/item/changestate/setactive', {:id => item.id}, 'rack.session' => {:user => user.id, :auth => true}
    ...
    it 'post /item/create should create a new item' do
      ...
      post '/item/create', { :item_picture => file, :name => 'Gold', :price => 100, :description => 'Very very valuable'}, 'rack.session' => { :user => user.id, :auth => true  }
