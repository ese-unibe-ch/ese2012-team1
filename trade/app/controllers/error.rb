...
module Controllers
  class Error < Sinatra::Application
    ...
    get '/error/:title' do
        ...
        elsif params[:title] == "No_Price"
          msg = "Please enter a price"
        elsif params[:title] == "No_Valid_Item_Id"
          msg = "The requested item id could not be found"
        elsif params[:title] == "No_Increment"
          msg = "Please enter an increment amount"
        elsif params[:title] == "Inc_Not_A_Number"
          msg = "Increment amount should be a number!"
        elsif params[:title] == "No_Valid_Time"
          msg = "The end date should be in future"
